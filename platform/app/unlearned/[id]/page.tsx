/**
 * /unlearned/[id] — The Unlearned: personal puzzle page.
 *
 * Shows one of the user's own imported puzzles in standard solve mode.
 * After solving, the user clicks "Next puzzle" to load another unsolved one.
...
export default async function UnlearnedPuzzlePage({ params }: PageProps) {
