...
export const metadata: Metadata = {
  ...
  description: "Top daily puzzle streaks on Cassandra Chess.",
};
...
export default async function LeaderboardPage({
  ...
  const activeTab = tab === "alltime" ? "alltime" : "current";
  const { current, allTime } = await getLeaderboard();
    ...
    <main className="min-h-screen bg-gray-50 px-4 py-10">
      <div className="max-w-2xl mx-auto">
        <div className="mb-6">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mt-3">Streak Leaderboard</h1>
          <p className="text-sm text-gray-500 mt-1">
            Solve at least one puzzle every day to keep your streak alive.
          </p>
        </div>
